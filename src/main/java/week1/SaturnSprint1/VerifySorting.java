...
public class VerifySorting {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * ArrayList<String> values2 = new ArrayList <String>(); List<WebElement>
		 * listSize2 = driver.findElements(By.xpath("//table/tbody/tr")); int size2 =
		 * listSize2.size(); System.out.println(size2); for(int i=1;i<size2;i++) {
		 * String List2 = driver.findElement(By.xpath("//table/tbody/tr["+i+
		 * "]/td[2]/following-sibling::th/span/a")).getText(); values2.add(List2);
		 * System.out.println(values2);
		 * 
		 * } if (values11.equals(values2)==true) {
		 ...
		 */
		  ...
		  //verify the sort in alphabetical order 
		Thread.sleep(3000); 
		String sort = driver.findElement(By.xpath("//span[text()='Sorted Ascending']")).getText();
